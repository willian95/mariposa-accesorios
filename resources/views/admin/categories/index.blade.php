            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p v-if="pictureStatus == 'listo' && imageProgress == 100">Contenido listo</p>
        ...
        const app = new Vue({
            ...
            methods:{
                ...
                store(){
                    ...
                    this.loading = true
                    axios.post("{{ url('admin/category/store') }}", {name: this.name, image: this.finalPictureName})
                    .then(res => {
                        this.loading = false
                ...
                update(){
                    ...
                    this.loading = true
                    axios.post("{{ url('admin/category/update') }}", {id: this.categoryId, name: this.name, image: this.finalPictureName})
                    .then(res => {
                        this.loading = false
                        if(res.data.success == true){
                ...
                createImage(file) {
                    if(file['type'].split('/')[0] == "image"){
                        ...
                        this.uploadMainImage(file, fileName)
