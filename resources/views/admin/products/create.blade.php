                ...
                store(){
                    ...
                    if(this.productFormatSizes.length > 0){
                        ...
                        if(completeUploading && this.pictureStatus == "listo"){
                            ...
                            this.loading = true
                            axios.post("{{ url('/admin/products/store') }}", {name:this.name, category: this.category, image: this.finalPictureName, imageHover: this.finalHoverPictureName, productFormatSizes: this.productFormatSizes, description: CKEDITOR.instances.editor1.getData(), workImages: this.imagesToUpload, mainImageFileType: this.mainImageFileType, isHighlighted: this.highlighted}).then(res => {
                                this.loading = false
