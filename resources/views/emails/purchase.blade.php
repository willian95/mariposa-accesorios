                  ...
                  <td width="540" align="center" valign="top" style="padding:0;Margin:0;"> 
                   <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-position:left bottom;" role="presentation"> 
                     ...
                     <tr style="border-collapse:collapse;"> 
                      ...
                      <tr>
                        <td>Nombre: {{ $purchase->buyer_name }} {{ $purchase->buyer_lastname }}</td>
                      </tr>
                      <tr>
                      <td>Total: USD {{ $total }} / Bs. {{ $total * $dolarToday }}</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                      <td>Orden #: {{ $purchase->order_id }}</td>
                      </tr>

                      <tr>
                        <td>
                        Hola {{ $purchase->buyer_name }} {{ $purchase->buyer_lastname }}, gracias por tu compra en Mariposa Accesorios, te llamaremos o enviaremos un email para indicarte los pasos siguientes.
                        </td>
                      </tr>
