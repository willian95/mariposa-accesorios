...
<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title>Mariposa Accesorios</title>
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed page-loading">
					...
					<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							...
							<ul class="menu-nav">
								...
								<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="{{ url('/admin/products/index') }}" class="menu-link">
													<i class="menu-bullet menu-bullet-line">
														<span></span>
													</i>
													<span class="menu-text">Listado</span>
								...
								<li class="menu-item" aria-haspopup="true">
									<a href="{{ url('/admin/categories/index') }}" class="menu-link">
								...
								<li class="menu-item" aria-haspopup="true">
									<a href="{{ url('/admin/colors/index') }}" class="menu-link">
								...
								<li class="menu-item" aria-haspopup="true">
									<a href="{{ url('/admin/banks/index') }}" class="menu-link">
										<i class="menu-icon flaticon2-arrow-1"></i>
								...
								<li class="menu-item" aria-haspopup="true">
									<a href="{{ url('/admin/sales/index') }}" class="menu-link">
										<i class="menu-icon flaticon2-arrow-1"></i>
										<span class="menu-text">Ventas</span>
									</a>
								</li>
					...
					<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark text-center" style="width: 100%;">
								...
								<a href="h#" target="_blank" class="text-dark-75 text-hover-primary">Mariposa creaciones Copyright</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Nav-->
							<!--end::Nav-->
		...
		<script src="{{ asset('admin/assets/js/pages/custom/user/list-datatable.js') }}"></script>
